...
function Table({
    ...
    const handleRemoveButton = () => {
        Swal.fire({
            ...
            if (result.isDenied) {
                fetch(process.env.API_DOMAIN + "/docs/65e53a11f56a6d7a5603a47f", {
                    method: "DELETE",
                    redirect: "follow",
                })
